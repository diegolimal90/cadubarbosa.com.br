...
(function (h) {
	...
	function Ca(a) {
		var b = m.defaults.oLanguage,
			c = a.sZeroRecords;
		!a.sEmptyTable && (c && "Não há dados no Relátorio" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
	...
	function B(a, b, c, d) {
		...
		if (i === k) return a.iDrawError != e && null === j && (J(a, 0, "Parametro requerido desconhecido " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e), j;
	...
	m.defaults = {
		...
		oLanguage: {
			...
			sSearchPlaceholder: "",
			sUrl: "",
			sZeroRecords: "Nenhum registro encontrato!"
		},
