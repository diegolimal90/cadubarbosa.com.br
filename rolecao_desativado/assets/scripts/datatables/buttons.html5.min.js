        ...
        text: function (a) {
            ...
            if (f.queryCommandSupported("copy")) {
                ...
                try {
                    f.execCommand("copy");
                    e.remove();
                    b.buttons.info(b.i18n("buttons.copyTitle", "Copiar para área de transferência"), b.i18n("buttons.copySuccess", {
                        1: "Copiado uma linha para a área de transferência",
                        _: "Copiado %d linhas para a área de transferência"
                    }, a.rows), 2E3);
                    return
                } catch (i) {
                }
            }
            a = g("<span>" + b.i18n("buttons.copyKeys", "Pressione <i>ctrl</i> ou <i>âŒ˜</i> + <i>C</i> Para copiar os dados da tabela<br>Para a área de transferência do sistema.<br><br>Para cancelar, clique nesta mensagem ou pressione ESC.") + "</span>").append(e);
