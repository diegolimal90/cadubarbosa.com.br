$(document).ready(function () {
    ...
    $("#strCep2").keyup(function () {

        if ($("#strCep2").val().length >= 9) {

            valorCep = $("#strCep2").val();
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function (result) {
                    $("#strCidade2").val(result.localidade);
                    $("#strBairro2").val(result.bairro);
                    $("#strRua2").val(result.logradouro);
                    $("#strComplemento2").val(result.complemento);
                }
            });
        }
    })
